...
description: "CloudInk theme provides multiple shortcodes on top of built-in ones in Hugo."
images: []
resources:
- name: "featured-image"
...
**CloudInk** theme provides multiple shortcodes on top of built-in ones in Hugo.
...
```markdown
{{</* person "https://dillonzq.com/" Dillon "author of the CloudInk theme" */>}}
```

This renders as {{< person "https://dillonzq.com/" Dillon "author of the CloudInk theme" >}}.
